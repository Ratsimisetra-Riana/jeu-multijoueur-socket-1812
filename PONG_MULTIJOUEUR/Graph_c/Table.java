...
public class Table extends JPanel {
    ...
    {   
        ...
        if(this.player_actuel==2)//mandefa ny position an'ny ball
        {
            try {//mandefa ny position anle ball
                this.client.getOut().writeUTF("position"+" "+Integer.toString(this.ball.getX())+" "+Integer.toString(this.ball.getY()));
            } catch (IOException e) {
    ...
    public void taperlaballe()
    {
        ...
        if((this.ball.y==this.pl1.y+this.pl1.height)&&(this.ball.x+this.ball.width>=this.pl1.x)&&(this.ball.x<=this.pl1.x+this.pl1.width))/*intercepter ball */
        {
            this.ball.direction=0;
            this.ball.directionx=0;
        }
        //if((this.ball.y+this.ball.height==this.pl2.y)&&(this.ball.x+this.ball.width>=this.pl2.x)&&(this.ball.x<=this.pl2.x+this.pl2.width))/*intercepter ball */
        /*{
            this.ball.direction=0;
            this.ball.directionx=0;
        }*/
